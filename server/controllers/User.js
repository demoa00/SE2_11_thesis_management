...
module.exports.createNewAuthenticatedSession =
  function createNewAuthenticatedSession(req, res, next) {
...
module.exports.deleteAuthenticatedSession = function deleteAuthenticatedSession(
  req,
  res,
  next
) {
