...
import { ProposalsViewComponent } from './components/proposals/proposals-view/proposals-view.component';
...
describe('StudentPageComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [StudentPageComponent, PageSkeletonComponent, ButtonComponent, AlertComponent, PopupComponent, IconComponent, DropdownCheckboxComponent, NotificationsContainerComponent, ProfilePageComponent, FiltersContainerComponent, RequestsViewComponent, RequestFormComponent, ProposalsViewComponent],
      providers: [
